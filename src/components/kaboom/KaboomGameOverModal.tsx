  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-md animate-fade-in">
      <div className="relative w-full max-w-sm rounded-3xl bg-gradient-to-b from-red-950 via-slate-950 to-black border-2 border-red-500/80 p-6 shadow-[0_0_60px_rgba(239,68,68,0.6)] text-center animate-screen-shake">
        ...
        {/* Warning Tag */}
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-red-500/20 border border-red-500/50 text-red-400 text-xs font-black tracking-widest uppercase mb-2">
          <Flame className="w-3.5 h-3.5 text-orange-400" />
          DETONATION TRIGGERED
        </div>

        {/* Headline */}
        <h2 className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-red-400 via-orange-400 to-amber-300 drop-shadow-[0_0_15px_rgba(239,68,68,0.8)] tracking-wide mb-1">
          KABOOM!
        </h2>
        ...
        {/* Detonator Callout */}
        <div className="bg-red-950/60 border border-red-500/30 rounded-2xl py-2 px-4 mb-5 text-sm text-red-200">
          <span className="font-extrabold text-white text-base">{detonatorName}</span> triggered the lethal bomb!
        </div>
        ...
        <div className="grid grid-cols-3 gap-2 mb-6">
          <div className="rounded-2xl bg-slate-900/90 border border-purple-500/30 p-2.5 flex flex-col items-center justify-center">
            <span className="text-[10px] uppercase font-bold text-gray-400 tracking-wider">Board</span>
            <span className="text-xs font-bold text-cyan-300 truncate w-full text-center mt-0.5">{gridTitle}</span>
          </div>

          <div className="rounded-2xl bg-slate-900/90 border border-purple-500/30 p-2.5 flex flex-col items-center justify-center">
            <span className="text-[10px] uppercase font-bold text-gray-400 tracking-wider">Survived</span>
            <span className="text-sm font-black text-amber-300 mt-0.5">{turnsSurvived} Turns</span>
          </div>

          <div className="rounded-2xl bg-slate-900/90 border border-purple-500/30 p-2.5 flex flex-col items-center justify-center">
            <span className="text-[10px] uppercase font-bold text-gray-400 tracking-wider">Bonuses</span>
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full py-3.5 px-5 rounded-2xl bg-gradient-to-r from-orange-500 via-red-500 to-orange-600 text-white font-black text-base shadow-[0_0_20px_rgba(239,68,68,0.6)] hover:brightness-110 active:scale-95 transition-all flex items-center justify-center gap-2 cursor-pointer"
          >
          ...
          <button
            ...
            className="w-full py-3 px-5 rounded-2xl bg-slate-900/90 border border-purple-400/40 text-purple-200 font-bold text-sm hover:border-purple-300 hover:text-white active:scale-95 transition-all flex items-center justify-center gap-2 cursor-pointer shadow-[0_0_15px_rgba(168,85,247,0.2)]"
          >
